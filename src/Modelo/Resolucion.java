...
public class Resolucion {
    ...
    private String depto_origen;
    private String municipio_origen;

    public Resolucion() {
    }

    public Resolucion(String num_resolucion, String cedula_principal, String nom_principal,String ape_principal,java.sql.Date fecha_resolucion, int fam_beneficiarias, double monto_resolucion, String emitida_por, java.sql.Date fecha_registro, String depto_origen, String municipio_origen) {
        ...
        this.depto_origen=depto_origen;
    ...
    public String toString() {
        return "Resolucion{" + "id_resolucion=" + id_resolucion + ", num_resolucion=" + num_resolucion + ", cedula_principal=" + cedula_principal + ", nom_principal=" + nom_principal + ", ape_principal=" + ape_principal + ", fecha_resolucion=" + fecha_resolucion + ", fam_beneficiarias=" + fam_beneficiarias + ", monto_resolucion=" + monto_resolucion + ", emitida_por=" + emitida_por + ", fecha_registro=" + fecha_registro + ", depto_origen=" + depto_origen + ", municipio_origen=" + municipio_origen + '}';
    }
    ...
    public String getDepto_origen() {
        return depto_origen;
    }

    public void setDepto_origen(String depto_origen) {
        this.depto_origen = depto_origen;
    }
